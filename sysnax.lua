-- Sysnax – Ultimate Rivals Script (No Key, Maclib UI)
-- Supports: Rivals, Arsenal, HyperShot
...
local SilentSec = LegitTab:Section("Silent Aim")
SilentSec:Toggle("Enabled", Config.Silent_Enabled, function(v) Config.Silent_Enabled=v end)
SilentSec:Dropdown("Target Part", {"Head","HumanoidRootPart"}, Config.Silent_Part, function(v) Config.Silent_Part=v end)
SilentSec:Slider("Hit Chance (%)", 0,100, Config.Silent_HitChance, function(v) Config.Silent_HitChance=v end)
SilentSec:Slider("Manipulation (Y)", -50,50, Config.Silent_Manipulation, function(v) Config.Silent_Manipulation=v end)
SilentSec:Toggle("Visible Only", Config.Silent_VisibleOnly, function(v) Config.Silent_VisibleOnly=v end)
SilentSec:Slider("Max Distance", 100,1000, Config.Silent_MaxDistance, function(v) Config.Silent_MaxDistance=v end)
SilentSec:Toggle("Draw FOV", Config.Silent_DrawFOV, function(v) Config.Silent_DrawFOV=v end)
SilentSec:Slider("FOV Radius", 50,500, Config.Silent_FOVRadius, function(v) Config.Silent_FOVRadius=v end)

local HitboxSec = LegitTab:Section("Extend Hitbox")
HitboxSec:Toggle("Enabled", Config.Hitbox_Enabled, function(v) Config.Hitbox_Enabled=v end)
HitboxSec:Dropdown("Part", {"Head","HumanoidRootPart"}, Config.Hitbox_Part, function(v) Config.Hitbox_Part=v end)
HitboxSec:Slider("Extend Rate", 1,50, Config.Hitbox_ExtendRate, function(v) Config.Hitbox_ExtendRate=v end)

local TriggerSec = LegitTab:Section("Triggerbot")
TriggerSec:Toggle("Enabled", Config.Trigger_Enabled, function(v) Config.Trigger_Enabled=v end)
TriggerSec:Slider("Delay (s)", 0,1, Config.Trigger_Delay, 2, function(v) Config.Trigger_Delay=v end)
TriggerSec:Slider("Distance", 100,500, Config.Trigger_Distance, function(v) Config.Trigger_Distance=v end)
TriggerSec:Keybind("Trigger Key", Config.Trigger_Key, function(v) Config.Trigger_Key=v end)

local PredSec = LegitTab:Section("Prediction")
PredSec:Toggle("Enabled", Config.Pred_Enabled, function(v) Config.Pred_Enabled=v end)
PredSec:Slider("Amount", 0.01,0.5, Config.Pred_Amount, 3, function(v) Config.Pred_Amount=v end)

local HitchanceSec = LegitTab:Section("Hit Chance")
HitchanceSec:Slider("Chance %", 0,100, Config.Hitchance_Value, function(v) Config.Hitchance_Value=v end)

local AutoWallSec = LegitTab:Section("Auto Wall")
AutoWallSec:Toggle("Enabled", Config.AutoWall_Enabled, function(v) Config.AutoWall_Enabled=v end)

-- Rage
local RageSec = RageTab:Section("Ragebot")
RageSec:Toggle("Enabled", Config.Rage_Enabled, function(v) Config.Rage_Enabled=v end)
RageSec:Toggle("Auto Shoot", Config.Rage_AutoShoot, function(v) Config.Rage_AutoShoot=v end)
RageSec:Toggle("Through Walls", Config.Rage_ThroughWalls, function(v) Config.Rage_ThroughWalls=v end)
RageSec:Slider("Prediction", 0,0.5, Config.Rage_Prediction, 3, function(v) Config.Rage_Prediction=v end)
RageSec:Slider("Max Shots/s", 1,20, Config.Rage_MaxShots, function(v) Config.Rage_MaxShots=v end)
RageSec:Toggle("Void Spam", Config.Rage_VoidSpam, function(v) Config.Rage_VoidSpam=v end)
RageSec:Slider("Hide Time", 0.1,2, Config.Rage_VoidHide, 2, function(v) Config.Rage_VoidHide=v end)
RageSec:Slider("Attack Time", 0.05,1, Config.Rage_VoidAttack, 2, function(v) Config.Rage_VoidAttack=v end)
RageSec:Toggle("Fly", Config.Rage_Fly, function(v) Config.Rage_Fly=v end)
RageSec:Slider("Fly Speed", 10,100, Config.Rage_FlySpeed, function(v) Config.Rage_FlySpeed=v end)
RageSec:Toggle("NoClip", Config.Rage_NoClip, function(v) Config.Rage_NoClip=v end)

-- Visuals
local ESPSec = VisualsTab:Section("ESP")
ESPSec:Toggle("Enabled", Config.ESP_Enabled, function(v) Config.ESP_Enabled=v end)
ESPSec:Toggle("Box", Config.ESP_Box, function(v) Config.ESP_Box=v end)
ESPSec:Toggle("Health Bar", Config.ESP_HealthBar, function(v) Config.ESP_HealthBar=v end)
ESPSec:Toggle("Skeleton", Config.ESP_Skeleton, function(v) Config.ESP_Skeleton=v end)
ESPSec:Toggle("Tracers", Config.ESP_Tracers, function(v) Config.ESP_Tracers=v end)
ESPSec:Toggle("Off-Screen", Config.ESP_OffScreen, function(v) Config.ESP_OffScreen=v end)
ESPSec:Toggle("Text Info", Config.ESP_Text, function(v) Config.ESP_Text=v end)
ESPSec:ColorPicker("Color", Config.ESP_Color, function(v) Config.ESP_Color=v end)

local ChamsSec = VisualsTab:Section("Chams")
ChamsSec:Toggle("Enabled", Config.Chams_Enabled, function(v) Config.Chams_Enabled=v end)
ChamsSec:Dropdown("Material", {"ForceField","Neon","Glass","Plastic"}, Config.Chams_Material, function(v) Config.Chams_Material=v end)
ChamsSec:ColorPicker("Color", Config.Chams_Color, function(v) Config.Chams_Color=v end)

local CrossSec = VisualsTab:Section("Crosshair")
CrossSec:Toggle("Enabled", Config.Crosshair_Enabled, function(v) Config.Crosshair_Enabled=v end)
CrossSec:Slider("Size", 5,30, Config.Crosshair_Size, function(v) Config.Crosshair_Size=v end)
CrossSec:Slider("Thickness", 1,10, Config.Crosshair_Thickness, function(v) Config.Crosshair_Thickness=v end)
CrossSec:ColorPicker("Color", Config.Crosshair_Color, function(v) Config.Crosshair_Color=v end)

local HitSec = VisualsTab:Section("Hit Feedback")
HitSec:Toggle("Hit Markers", Config.HitMarkers_Enabled, function(v) Config.HitMarkers_Enabled=v end)
HitSec:Toggle("Hit Sounds", Config.HitSounds_Enabled, function(v) Config.HitSounds_Enabled=v end)

-- Weapon
local WpnSec = WeaponTab:Section("Modifications")
WpnSec:Toggle("No Recoil", Config.NoRecoil_Enabled, function(v) Config.NoRecoil_Enabled=v end)
WpnSec:Toggle("No Spread", Config.NoSpread_Enabled, function(v) Config.NoSpread_Enabled=v end)
WpnSec:Toggle("Rapid Fire", Config.RapidFire_Enabled, function(v) Config.RapidFire_Enabled=v end)
WpnSec:Slider("Fire Rate Multiplier", 1,5, Config.RapidFire_Mult, 1, function(v) Config.RapidFire_Mult=v end)
WpnSec:Toggle("Fast Reload", Config.FastReload_Enabled, function(v) Config.FastReload_Enabled=v end)
WpnSec:Toggle("Infinite Ammo", Config.InfiniteAmmo_Enabled, function(v) Config.InfiniteAmmo_Enabled=v end)

-- Player
local MoveSec = PlayerTab:Section("Movement")
MoveSec:Toggle("Speed", Config.Speed_Enabled, function(v) Config.Speed_Enabled=v end)
MoveSec:Slider("Speed Value", 16,100, Config.Speed_Value, function(v) Config.Speed_Value=v end)
MoveSec:Toggle("Infinite Jump", Config.InfiniteJump_Enabled, function(v) Config.InfiniteJump_Enabled=v end)
MoveSec:Toggle("NoClip", Config.NoClip_Enabled, function(v) Config.NoClip_Enabled=v end)
MoveSec:Toggle("Fly", Config.Fly_Enabled, function(v) Config.Fly_Enabled=v end)
MoveSec:Slider("Fly Speed", 10,100, Config.Fly_Speed, function(v) Config.Fly_Speed=v end)
MoveSec:Toggle("Fullbright", Config.Fullbright_Enabled, function(v) Config.Fullbright_Enabled=v end)

local AntiAimSec = PlayerTab:Section("Anti-Aim")
AntiAimSec:Toggle("Enabled", Config.AntiAim_Enabled, function(v) Config.AntiAim_Enabled=v end)
AntiAimSec:Dropdown("Type", {"Spin","Down"}, Config.AntiAim_Type, function(v) Config.AntiAim_Type=v end)

local FakeLagSec = PlayerTab:Section("Fake Lag")
FakeLagSec:Toggle("Enabled", Config.FakeLag_Enabled, function(v) Config.FakeLag_Enabled=v end)
FakeLagSec:Slider("Amount (ms)", 0,1000, Config.FakeLag_Amount, function(v) Config.FakeLag_Amount=v end)

-- Skin Changer
local SkinSec = SkinTab:Section("ID‑less Skin Changer")
SkinSec:Toggle("Enabled", Config.Skin_Enabled, function(v) Config.Skin_Enabled=v end)
SkinSec:Dropdown("Material", {"ForceField","Neon","Glass","Plastic","SmoothPlastic","Metal","Wood","Foil"}, Config.Skin_Material, function(v) Config.Skin_Material=v end)
SkinSec:ColorPicker("Color", Config.Skin_Color, function(v) Config.Skin_Color=v end)

-- Spoofer
local NameSec = SpoofTab:Section("Name Spoofer")
NameSec:Toggle("Enabled", Config.NameSpoof_Enabled, function(v) Config.NameSpoof_Enabled=v end)
NameSec:Textbox("Display Name", Config.NameSpoof_Text, function(v) Config.NameSpoof_Text=v end)

local StatSec = SpoofTab:Section("Stat Spoofer")
StatSec:Toggle("Enabled", Config.StatSpoof_Enabled, function(v) Config.StatSpoof_Enabled=v end)
StatSec:Textbox("Level", Config.StatSpoof_Level, function(v) Config.StatSpoof_Level=v end)
StatSec:Textbox("Winstreak", Config.StatSpoof_Winstreak, function(v) Config.StatSpoof_Winstreak=v end)

-- Config
local CfgSec = ConfigTab:Section("Configurations")
local cfgInput = CfgSec:Textbox("Config Name", "", function() end)
CfgSec:Button("Save", function() saveCfg(cfgInput.Value) end)
CfgSec:Button("Load", function() loadCfg(cfgInput.Value) end)
CfgSec:Button("Delete", function() delCfg(cfgInput.Value) end)
local cfgList = listCfgs()
local cfgDrop = CfgSec:Dropdown("Existing", cfgList, cfgList[1] or "", function(v) cfgInput:SetValue(v) end)
CfgSec:Button("Refresh", function() cfgDrop:Refresh(listCfgs()) end)

local WmSec = ConfigTab:Section("Watermark")
WmSec:Toggle("Show Watermark", Config.Watermark_Enabled, function(v) Config.Watermark_Enabled=v end)
WmSec:Button("Update Watermark", updateWatermark)

-- ==================== FINALISE ====================
Window:SetToggleKey(Enum.KeyCode.RightShift)
Window:Toggle() -- hide on start
