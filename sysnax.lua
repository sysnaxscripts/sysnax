...
-- All features, zero bugs, zero kicks
-- Toggle: Right Shift
...
mt.__namecall = newcclosure(function(...)
    ...
    if (method == "FireServer" or method == "InvokeServer") and type(args[1]) == "string" then
        ...
        if remoteName == "MouseClick" or remoteName == "Shoot" or remoteName == "Bullet" or remoteName == "Fire" then
...
WindUI:Notify({Title="Sysnax", Content="🥳 Script loaded! All features ready for " .. CurrentGame .. ".", Duration=6})