--[[
    SYSNAX – Ultimate Rivals Script (WindUI) – Fully Functional UI
    Toggle: Right Shift
--]]
...
RageSec:Toggle({Title="Instant Fire", Default=CurrentConfig.Rage_InstantFire, Callback=function(v) CurrentConfig.Rage_InstantFire=v end})
...
-- === SKIN CHANGER ===
local SkinSec = Tabs.Skin:Section({Title = "Skin Changer"})
...
WindUI:Notify({Title="Sysnax", Content="Script loaded. Tabs are full of features. Right Shift to toggle.", Duration=6})